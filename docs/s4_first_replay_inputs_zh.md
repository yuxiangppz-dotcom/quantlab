...
| G5 费用边界 | 已明确 | 已知：佣金万 0.86 最低 5 元、卖方印花税分时点；未知：additional_fee_rate/fixed（不过零、不重复计）。**最少待确认项（一个问题）**：2022 年这笔交易，券商是否在万分之 0.86 佣金之外另收过户费/征管费等固定或比例费用？若有，费率或金额是多少？——影响字段：`additional_fee_rate`、`additional_fee_fixed_fen` |
