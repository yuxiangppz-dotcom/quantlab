...
from quantlab.research.dividend_event_run import OUTPUT, read_report
...
def render_dividend_events():
    ...
    try:
        ...
        c.metric("研究期候选冲突", f"{report['candidate_conflict_groups_date_window']:,} 组")
            ...
            table.append(
                {
                    ...
                    "已知退出后发放的候选": row.get("payments_after_intended_exit", 0),
